<?php $__env->startSection('content'); ?>
        ...
        <div class="row">
            <div class="col-xs-6 col-md-4">
                <div class="alert alert-info">
                    <?php echo e(trans('quickadmin::qa.menus-index-no_menu_items_found')); ?>
    ...
    <div class="row">
        <div class="col-xs-12 form-group">
            <a href="<?php echo e(route('menu.crud')); ?>" class="btn btn-primary"><?php echo e(trans('quickadmin::qa.menus-index-new_crud')); ?></a>
            <a href="<?php echo e(route('menu.custom')); ?>" class="btn btn-primary"><?php echo e(trans('quickadmin::qa.menus-index-new_custom')); ?></a>
            <a href="<?php echo e(route('menu.parent')); ?>" class="btn btn-primary"><?php echo e(trans('quickadmin::qa.menus-index-new_parent')); ?></a>
        </div>
    </div>
    ...
    <?php if($menusList->count() != 0): ?>
        <div class="row">
            <div class="col-xs-6 col-md-4">
                <div class="alert alert-danger">
                    <?php echo e(trans('quickadmin::qa.menus-index-positions_drag_drop')); ?>
    ...
    <?php if($menusList->count() != 0): ?>
        ...
        <div class="row" id="dragMessage" style="display: none;">
            <div class="col-xs-6 col-md-4">
                <div class="alert alert-danger">
                    <?php echo e(trans('quickadmin::qa.menus-index-click_save_positions')); ?>
        ...
        <div class="row">
            <div class="col-xs-12">
                <?php echo Form::submit(trans('quickadmin::qa.menus-index-save_positions'),['class' => 'btn btn-danger']); ?>
